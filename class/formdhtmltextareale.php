<?php
// $Id: formdhtmltextareale.php,v 1.1 2006/03/27 15:37:46 mikhail Exp $
//  ------------------------------------------------------------------------ //
 ...
 * @copyright    copyright (c) 2000-2005 XOOPS.org
 */
class XoopsFormDhtmlTextAreaLe extends XoopsFormTextArea
{
    /**
     * Hidden text
     * @var    string
    ...
    public function XoopsFormDhtmlTextAreaLe($caption, $name, $value, $rows = 5, $cols = 50, $hiddentext = 'xoopsHiddenText')
    {
    ...
    public function render()
    {
        ...
        // вн link д╚дл quote д╚дл

        if (!(defined('_DHTML_NO_DHTML_CODE') && _DHTML_NO_DHTML_CODE === true)) {
            $ret .= "<a name='moresmiley'></a><img onmouseover='style.cursor=\"hand\"' src='"
                    . XOOPS_URL
                    ...
                    . XOOPS_URL
                    . "/images/imgsrc.gif' alt='imgsrc'>&nbsp;<img onmouseover='style.cursor=\"hand\"' onclick='javascript:openWithSelfMain(\""
                    . XOOPS_URL
                    . '/imagemanager.php?target='
                    . $this->getName()
                    . "\",\"imgmanager\",400,430);' src='"
                    . XOOPS_URL
                    . "/images/image.gif' alt='image'>&nbsp;<img src='"
                    . XOOPS_URL
        ...
        if (!(defined('_DHTML_NO_DHTML_CODE_FONT') && _DHTML_NO_DHTML_CODE_FONT === true)) {
            ...
            $ret .= "<img onclick='javascript:setVisible(\""
                    . $this->_hiddenText
                    . '");makeBold("'
                    . $this->_hiddenText
                    . "\");' onmouseover='style.cursor=\"hand\"' src='"
                    ...
                    . "\");' src='"
                    . XOOPS_URL
                    . "/images/linethrough.gif' alt='linethrough' onmouseover='style.cursor=\"hand\"'>&nbsp;&nbsp;<input type='text' id='"
                    . $this->getName()
            ...
            //$ret .= "<textarea rows='".$this->getRows()."'".$this->getExtra().">".$this->getValue()."</textarea><br>\n";
        }// if (!(defined("_DHTML_NO_DHTML_CODE_FONT") &&  _DHTML_NO_DHTML_CODE_FONT === true))

        // вн smily

        if (!(defined('_DHTML_NO_DHTML_CODE_SMILY') && _DHTML_NO_DHTML_CODE_SMILY === true)) {
        ...
        if (empty($smileys)) {
            ...
            for ($i = 0; $i < $count; $i++) {
                if (1 == $smiles[$i]['display']) {
                    $ret .= "<img onclick='xoopsCodeSmilie(\"" . $this->getName() . '", " ' . $smiles[$i]['code'] . " \");' onmouseover='style.cursor=\"hand\"' src='" . XOOPS_UPLOAD_URL . '/' . htmlspecialchars($smiles['smile_url']) . "' border='0' alt=''>";
                }
            }
        }
